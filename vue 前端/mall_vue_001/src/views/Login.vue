<template>
    <div class="wrapper">
        ...
        <!-- 登录表单 ref="loginForm"相当于定义 id="xxx" 在js代码中可以使用loginForm名字获得该Form表单对象v-model 双向数据绑定，变量中值可以显示在 文本框，文本框的值修改，也可以同步回变量-->
...
const login = () =>{
    //通过loginFrom表单对象，调用该对象 validate()验证方法，如果定义验证规则通过，v是true，否则是
    false
